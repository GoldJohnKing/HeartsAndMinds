...
if (isServer) then {
    ...
    btc_side_list_use = ["supply", "mines", "vehicle", "get_city", "tower", "civtreatment", "checkpoint", "convoy", "rescue", "capture_officer", "hostage", "hack"]; // Edited: Define using side-missions
