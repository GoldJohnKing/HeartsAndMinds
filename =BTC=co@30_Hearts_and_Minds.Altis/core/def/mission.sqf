...
if (isServer) then {
    ...
    _rearming_static = // Edited: Change _rearming_static list
        ...
        + ["ace_dragon_staticAssembled","RHS_Stinger_AA_pod_D","rhs_Igla_AA_pod_vdv","RHS_ZU23_VDV","RHS_M119_D","rhs_D30_vdv","rhs_D30_at_vdv"];
