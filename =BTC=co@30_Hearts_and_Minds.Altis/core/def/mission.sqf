...
btc_fnc_log_get_nottowable = {
    ...
    switch (true) do { // Edited: make heavy vehicle tow everything
...
switch (_p_en) do {
    ...
    case "RHS_FACTION_VDV" : {
        ...
        btc_type_motorized = ["RHS_Mi24P_vvs","RHS_Mi8AMTSh_vvs","RHS_Mi8MTV3_heavy_vvs","RHS_Ka52_vvs","rhs_mi28n_vvs","RHS_Su25SM_vvs","rhs_mig29sm_vvs","RHS_T50_vvs_generic_ext"] + ["min_rf_gaz_2330_HMG","min_rf_truck_covered","min_rf_gaz_2330_HMG_desert","min_rf_truck_covered_desert","min_rf_heli_light_black","min_rf_ka_52","min_rf_ka_52_grey","min_rf_heli_light_grey","min_rf_su_34"] + ["I_E_Heli_light_03_dynamicLoadout_F"];
        btc_type_motorized_armed = ["RHS_BM21_VDV_01","rhs_2s3_tv","rhs_2s1_vmf","rhs_zsu234_aa","RHS_Ural_Zu23_VDV_01","rhs_sprut_vdv","rhs_t72be_tv","rhs_t80um","rhs_t90sm_tv","rhs_btr80a_vdv","rhs_bmd1r","rhs_bmd2m","rhs_bmd4m_vdv","rhs_bmd4ma_vdv","rhs_brm1k_vdv","rhs_tigr_sts_vdv","rhs_kamaz5350_vdv","rhs_bmp2_vdv","rhs_bmp2e_vdv","rhs_bmp2d_vdv"] + ["min_rf_t_14","min_rf_t_14_desert","min_rf_t_15","min_rf_t_15_desert","min_rf_2b26_desert","min_rf_2b26","min_rf_sa_22_desert","min_rf_sa_22"] + ["I_E_APC_tracked_03_cannon_F","I_E_Truck_02_MRL_F"];
