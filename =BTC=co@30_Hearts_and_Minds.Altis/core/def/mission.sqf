...
btc_p_trigger = if (("btc_p_trigger" call BIS_fnc_getParamValue) isEqualTo 1) then {
    //Edited: Default = 190
    "this && !btc_db_is_saving && (false in (thisList apply {_x isKindOf 'Plane'})) && (false in (thisList apply {(_x isKindOf 'Helicopter') && (speed _x > 150)}))"
} else {
...
if (isServer) then {
    ...
    btc_helo = [btc_helo_1, btc_helo_2, btc_helo_3, btc_helo_4, btc_helo_5, btc_helo_6, btc_helo_7, btc_helo_8];
...
//Edited: Exclude some buggy vehicles
btc_civ_type_veh = btc_civ_type_veh - ["C_Van_02_vehicle_F","C_IDAP_Van_02_vehicle_F"];

//Edited: Modified armed civilian type, defaults are below:
...
btc_fnc_log_get_nottowable = {
    ...
    //Edited: Make it easier to tow aircrafts
    switch (true) do {
        ...
        case (_tower isKindOf "Ship") : {["Plane"];};
        //The tower is a car so it can't tow: truck, tank, plane and helicopter
        case (_tower isKindOf "Car") : {["Truck", "Truck_F", "Tank", "Plane", "Helicopter", "Ship"];};
...
_allclasse = [[_p_en, "RHS_FACTION_TV", "RHS_FACTION_VVS"], _p_en_AA, _p_en_tank] call btc_fnc_mil_class; //Edited: Create classes from factions, you can combine factions like that: [[_p_en , "IND_F"], _p_en_AA, _p_en_tank] call btc_fnc_mil_class;
...
switch (_p_en) do {
    ...
    case "RHS_FACTION_VDV" : {
        ...
        btc_type_motorized = ["rhs_kamaz5350_vdv","rhs_kamaz5350_open_vdv","rhs_bmp2_vdv","rhs_bmp2e_vdv","rhs_bmp2d_vdv","RHS_Mi24P_vvs","RHS_Mi8AMTSh_vvs","RHS_Mi8MTV3_heavy_vvs"];
        btc_type_motorized_armed = ["rhs_zsu234_aa","rhs_btr80a_vdv","rhs_bmd1r","rhs_bmd2m","rhs_bmd4m_vdv","rhs_bmd4ma_vdv","rhs_bmp2d_vdv","rhs_brm1k_vdv","rhs_t80bvk","rhs_t90a_tv","RHS_Ka52_vvs","rhs_mi28n_vvs","RHS_Su25SM_vvs","rhs_mig29sm_vvs","RHS_T50_vvs_generic_ext"];
    };
};
