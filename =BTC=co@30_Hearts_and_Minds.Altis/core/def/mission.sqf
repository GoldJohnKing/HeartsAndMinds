...
_allclasse = [[_p_en, "RHS_FACTION_TV", "RHS_FACTION_VVS"], _p_en_AA, _p_en_tank] call btc_fnc_mil_class; //Edited: Add more faction - Create classes from factions, you can combine factions like that: [[_p_en , "IND_F"], _p_en_AA, _p_en_tank] call btc_fnc_mil_class;
...
switch (_p_en) do {
    ...
    case "RHS_FACTION_VDV" : { // Edited: Modify RHSAFRF Faction
