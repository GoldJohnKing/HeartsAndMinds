...
if (isServer) then {
    ...
    btc_side_list_use = ["supply", "mines", "vehicle", "get_city", "tower", "civtreatment", "checkpoint", "underwater_generator", "rescue", "hostage", "hack"]; // Edited: Define using side-missions
