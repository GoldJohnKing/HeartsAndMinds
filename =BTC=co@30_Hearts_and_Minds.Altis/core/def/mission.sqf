...
btc_p_city_free_trigger = "btc_p_city_free_trigger" call BIS_fnc_getParamValue; // Edited: Use a different method to trigger enemy surrender, default are below
...
if (isServer) then {
    ...
    //Patrol
    btc_patrol_active = [];
    btc_patrol_area = 1500; // Edited: Tweak enemy patrol spawn range, default = 2500
    ...
    //Side
    btc_side_ID = 0;
    btc_side_list = ["supply", "mines", "vehicle", "get_city", "tower", "checkpoint", "rescue", "hostage", "kill", "EMP", "removeRubbish", "hack"]; //On ground (Side "convoy" and "capture_officer" are not design for map with different islands. Start and end city can be on different islands.) // Edited: Exclude "capture_officer", "convoy", "civtreatment"
    if (btc_p_sea) then {btc_side_list append ["underwater_generator"]}; //On sea // Edited: Exclude "civtreatment_boat"
...
private _allclasse = [[_p_civ, "CIV_IDAP_F"]] call btc_civ_fnc_class; // Edited: Add more civ factions - Create classes from factions, you can combine factions from the SAME side : [[_p_civ, "btc_ac","LOP_TAK_CIV"]] call btc_civ_fnc_class.

//Save class name to global variable
btc_civ_type_units = _allclasse select 0;
_allclasse = [[_p_civ_veh, "CIV_IDAP_F"]] call btc_civ_fnc_class; // Edited: Add more civ vehicle factions
...
switch (_p_en) do {
    ...
    case "RHS_FACTION_VDV" : {
        ...
        btc_type_motorized =
            ...
            + ["vn_o_air_mi2_04_04","vn_o_air_mi2_04_06","vn_o_air_mi2_04_02","vn_o_air_mi2_05_02","vn_o_air_mi2_05_04","vn_o_air_mi2_03_04"]; // Edited: Add VN DLC vehicles
        btc_type_motorized_armed =
            ...
            + ["vn_o_armor_type63_01_nva65","vn_o_armor_m41_01","vn_o_wheeled_btr40_mg_03_nvam","vn_o_wheeled_z157_mg_02_nvam","vn_b_wheeled_m54_mg_01","vn_b_wheeled_m54_mg_02"]; // Edited: Add VN DLC vehicles
        btc_type_mg =
            ["rhs_KORD_VDV","rhs_KORD_high_VDV","RHS_NSV_TriPod_VDV","RHS_AGS30_TriPod_VDV"] // Edited: Add RHSAFRF MGs
            + ["O_HMG_01_F","O_HMG_01_high_F","O_GMG_01_F","O_GMG_01_high_F"] // Edited: Add CSAT MGs
            + ["min_rf_AGS_30","min_rf_Kord"] // Edited: Add 2035 Russian Armed Forces MGs
            + ["vn_o_nva_navy_static_dshkm_low_01"]; // Edited: Add VN DLC MGs
        btc_type_gl =
            ["rhs_Metis_9k115_2_vdv","rhs_Kornet_9M133_2_vdv","rhs_SPG9M_VDV"] // Edited: Add RHSAFRF GLs
            + ["O_static_AT_F","O_static_AA_F"] // Edited: Add CSAT GLs
            + ["min_rf_Metis"] // Edited: Add 2035 Russian Armed Forces GLs
            + ["vn_o_nva_65_static_d44"]; // Edited: Add VN DLC GLs
        btc_type_motar = // Edited: Add a new type for enemy mortar and static AA
            ["rhs_2b14_82mm_vdv","rhs_D30_vmf","RHS_ZU23_VDV","rhs_Igla_AA_pod_vdv"] // Edited: Add RHSAFRF mortar and static AAs
            + ["O_G_Mortar_01_F"] // Edited: Add CSAT mortar and static AAs
            + ["vn_o_nva_navy_static_mortar_type53","vn_o_nva_navy_static_d44_01","vn_o_nva_navy_static_zpu4"]; // Edited: Add VN DLC mortar and static AAs
        btc_type_boats = btc_type_boats + ["vn_o_boat_03_02","vn_o_boat_04_02"]; // Edited: Add VN DLC boats
    };
};
