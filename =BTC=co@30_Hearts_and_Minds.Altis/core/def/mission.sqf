...
btc_p_trigger = if (("btc_p_trigger" call BIS_fnc_getParamValue) isEqualTo 1) then {
    "this && !btc_db_is_saving && (false in (thisList apply {_x isKindOf 'Plane'})) && (false in (thisList apply {(_x isKindOf 'Helicopter') && (speed _x > 125)}))"//Edited: Default = 190
} else {
...
btc_fnc_log_get_nottowable = {
    params ["_tower"];
    /* Edited: Make it easier to tow aircrafts, defaults are:
    switch (true) do {
...
switch (_p_en) do {
    ...
    case "RHS_FACTION_VDV" : {
        ...
        btc_type_motorized = ["rhs_kamaz5350_vdv","rhs_kamaz5350_open_vdv","rhs_bmp2_vdv","rhs_bmp2e_vdv","rhs_bmp2d_vdv","RHS_Mi24P_vvs","RHS_Mi8AMTSh_vvs","RHS_Mi8MTV3_heavy_vvs","RHS_T50_vvs_generic_ext","rhs_2s3_tv"];
        btc_type_motorized_armed = ["rhs_zsu234_aa","rhs_btr80a_vdv","rhs_bmd1r","rhs_bmd2m","rhs_bmd4m_vdv","rhs_bmd4ma_vdv","rhs_bmp2d_vdv","rhs_brm1k_vdv","rhs_t80bvk","rhs_t90a_tv","RHS_Ka52_vvs","rhs_mi28n_vvs","RHS_Su25SM_vvs","rhs_mig29sm_vvs","RHS_T50_vvs_generic_ext","RHS_BM21_VDV_01"];
    };
};
