...
switch (_p_en) do {
    ...
    case "RHS_FACTION_VDV" : {
        ...
        btc_type_motorized = ["RHS_Mi24P_vvs","RHS_Mi8AMTSh_vvs","RHS_Mi8MTV3_heavy_vvs","RHS_Ka52_vvs","rhs_mi28n_vvs","RHS_Su25SM_vvs","rhs_mig29sm_vvs","RHS_T50_vvs_generic_ext"] + ["RHS_Mi24P_vvs","RHS_Mi8AMTSh_vvs","RHS_Mi8MTV3_heavy_vvs","RHS_Ka52_vvs","rhs_mi28n_vvs"]; // Edited: Only allow helis and planes as enemy motorized vehicles & Increase probability for helis
        ...
        btc_type_mg = ["rhs_KORD_VDV","rhs_KORD_high_VDV","RHS_NSV_TriPod_VDV","RHS_AGS30_TriPod_VDV"] + ["O_G_HMG_02_F","O_G_HMG_02_high_F","O_HMG_01_A_F","O_GMG_01_A_F"];
        btc_type_gl = ["rhs_Metis_9k115_2_vdv","rhs_Kornet_9M133_2_vdv","rhs_SPG9M_VDV"];
