...
if (isServer) then {
    ...
    //btc_helo = [btc_helo_1, btc_helo_2, btc_helo_3, btc_helo_4, btc_helo_5, btc_helo_6, btc_helo_7, btc_helo_8, btc_helo_9, btc_helo_10, btc_helo_11, btc_helo_12, btc_helo_13, btc_helo_14, btc_helo_15, btc_helo_16, btc_helo_17, btc_helo_18];
    btc_vehicles = [];
    btc_helo = [];
...
private _allclasse = [[_p_civ,"CIV_F"]] call btc_fnc_civ_class; //Edited - Create classes from factions, you can combine factions from the SAME side : [[_p_civ , "btc_ac","LOP_TAK_CIV"]] call btc_fnc_civ_class.

//Save class name to global variable
btc_civ_type_units = _allclasse select 0;
_allclasse = [[_p_civ_veh,"CIV_F"]] call btc_fnc_civ_class; //Edited
...
_allclasse = [[_p_en, "IND_G_F", "IND_C_F", "BLU_G_F"], _p_en_AA, _p_en_tank] call btc_fnc_mil_class; //Edited - Create classes from factions, you can combine factions like that: [[_p_en , "IND_F"], _p_en_AA, _p_en_tank] call btc_fnc_mil_class;
...
switch (_p_en) do {
    ...
    case "OPF_G_F" : {
        btc_type_units = btc_type_units - ["O_G_officer_F","O_G_Soldier_unarmed_F","O_G_Survivor_F","B_G_officer_F","B_G_Soldier_unarmed_F","B_G_Survivor_F","I_G_officer_F","I_G_Soldier_unarmed_F","I_G_Survivor_F","I_C_Helipilot_F","I_C_Pilot_F","I_G_Story_Protagonist_F","I_G_Story_SF_Captain_F","I_G_resistanceLeader_F","I_C_Soldier_Camo_F"];
        btc_type_motorized = ["I_G_Offroad_01_F","I_G_Offroad_01_armed_F","I_Quadbike_01_F","I_G_Quadbike_01_F","I_MRAP_03_F","I_MRAP_03_hmg_F","I_MRAP_03_gmg_F","I_Truck_02_covered_F","I_Truck_02_transport_F","I_G_Van_01_transport_F","I_C_Offroad_02_unarmed_F","I_C_Offroad_02_unarmed_brown_F","I_C_Offroad_02_unarmed_olive_F","I_C_Van_01_transport_F","I_C_Van_01_transport_brown_F","I_C_Van_01_transport_olive_F"];
        btc_type_motorized_armed = ["I_G_Offroad_01_F","I_G_Offroad_01_armed_F","I_Quadbike_01_F","I_G_Quadbike_01_F","I_MRAP_03_F","I_MRAP_03_hmg_F","I_MRAP_03_gmg_F","I_Truck_02_covered_F","I_Truck_02_transport_F","I_G_Van_01_transport_F","I_C_Offroad_02_unarmed_F","I_C_Offroad_02_unarmed_brown_F","I_C_Offroad_02_unarmed_olive_F","I_C_Van_01_transport_F","I_C_Van_01_transport_brown_F","I_C_Van_01_transport_olive_F"];
        btc_type_gl = btc_type_gl + ["I_G_Mortar_01_F"];
    };
};
