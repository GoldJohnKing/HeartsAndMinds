...
if (isServer) then {
    ...
    //Patrol
    btc_patrol_active = [];
    btc_patrol_area = 1500; // Edited: Decrease patrol range due to performance issue, default = 2500
    ...
    btc_vehicles = [btc_veh_1, btc_veh_2, btc_veh_3, btc_veh_4, btc_veh_5, btc_veh_6, btc_veh_7, btc_veh_8, btc_veh_9, btc_veh_10, btc_veh_11, btc_veh_12, btc_veh_13, btc_veh_14, btc_veh_15, btc_veh_16, btc_veh_17, btc_veh_18, btc_veh_19, btc_veh_20, btc_veh_21, btc_veh_22, btc_veh_23, btc_veh_24, btc_veh_25, btc_veh_26, btc_veh_27, btc_veh_28, btc_veh_29, btc_veh_30, btc_veh_31, btc_veh_32]; // Edited: Modified according to player vehicles
    btc_helo = [btc_helo_1, btc_helo_2, btc_helo_3, btc_helo_4, btc_helo_5, btc_helo_6, btc_helo_7, btc_helo_8, btc_helo_9, btc_helo_10, btc_helo_11, btc_helo_12, btc_helo_13, btc_helo_14, btc_helo_15, btc_helo_16, btc_helo_17, btc_helo_18, btc_helo_19]; // Edited: Modified according to player vehicles
...
switch (_p_en) do {
    ...
    case "RHS_FACTION_VDV" : {
        ...
        btc_type_motorized = ["RHS_Mi24P_vvs","RHS_Mi8AMTSh_vvs","RHS_Mi8MTV3_heavy_vvs","RHS_Ka52_vvs","rhs_mi28n_vvs","RHS_Su25SM_vvs","rhs_mig29sm_vvs","RHS_T50_vvs_generic_ext"]; // Edited: Full list = ["rhs_tigr_sts_vdv","rhs_kamaz5350_vdv","rhs_bmp2_vdv","rhs_bmp2e_vdv","rhs_bmp2d_vdv","RHS_Mi24P_vvs","RHS_Mi8AMTSh_vvs","RHS_Mi8MTV3_heavy_vvs"]
        btc_type_motorized_armed = ["RHS_BM21_VDV_01","rhs_2s3_tv","rhs_2s1_vmf","rhs_zsu234_aa","RHS_Ural_Zu23_VDV_01","rhs_btr80a_vdv","rhs_bmd1r","rhs_bmd2m","rhs_bmd4m_vdv","rhs_bmd4ma_vdv","rhs_brm1k_vdv","rhs_sprut_vdv","rhs_t72be_tv","rhs_t80um","rhs_t90sm_tv"] + ["rhs_tigr_sts_vdv","rhs_bmp2_vdv","rhs_bmp2e_vdv","rhs_bmp2d_vdv"]; // Edited: Full list = ["RHS_BM21_VDV_01","rhs_2s3_tv","rhs_2s1_vmf","rhs_zsu234_aa","RHS_Ural_Zu23_VDV_01","rhs_btr80a_vdv","rhs_bmd1r","rhs_bmd2m","rhs_bmd4m_vdv","rhs_bmd4ma_vdv","rhs_brm1k_vdv","rhs_sprut_vdv","rhs_t72be_tv","rhs_t80um","rhs_t90sm_tv","RHS_Ka52_vvs","rhs_mi28n_vvs","RHS_Su25SM_vvs","rhs_mig29sm_vvs","RHS_T50_vvs_generic_ext"]
