...
waitUntil {sleep 5;
    ...
    // _veh getHit "wheel_1_1_steering" < 1 || // Edited: Change mission complete condition to fully repaired
    damage _veh < 0.1 || // Edited: Change mission complete condition to fully repaired
    !alive _veh
};
