...
switch (_side) do {
    case 0 : {[] call btc_fnc_side_get_city;};
    ...
    case 7 : {[] call btc_fnc_side_hack;};
    case 8 : {[] call btc_fnc_side_tower;};
    case 9 : {[] call btc_fnc_side_get_city;};
    case 10 : {[] call btc_fnc_side_tower;};
    case 11 : {[] call btc_fnc_side_checkpoint;};
    case 12 : {[] call btc_fnc_side_hack;};
