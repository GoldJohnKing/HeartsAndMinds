...
//Edited - Deleted mission names are: 0-btc_fnc_side_supply, 2-btc_fnc_side_vehicle, 9-btc_fnc_side_convoy
switch (_side) do {
    case 0 : {[] call btc_fnc_side_hack;};
    case 1 : {[] call btc_fnc_side_mines;};
    case 2 : {[] call btc_fnc_side_checkpoint;};
    ...
    case 9 : {[] call btc_fnc_side_tower;};
