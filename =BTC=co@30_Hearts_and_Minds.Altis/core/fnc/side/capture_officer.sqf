...
//Edited: Have a larger range, default: 100
waitUntil {sleep 5; (btc_side_aborted || btc_side_failed || !(alive _captive) || (_captive inArea [getPosWorld btc_create_object_point, 300, 300, 0, false]))};
