...
switch true do {
    ...
    case (_type isKindOf "LandVehicle" || {_type isKindOf "Air" || {_type isKindOf "StaticWeapon" || {_type isKindOf "Ship"}}}) : { // Edited: Make Air and StaticWeapon towable, default = (_type isKindOf "LandVehicle" || {_type isKindOf "Ship"})
