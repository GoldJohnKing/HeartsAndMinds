...
if !(_vehicle isKindOf "B_APC_Tracked_01_CRV_F" || _vehicle isKindOf "rhsusf_stryker_m1132_m2_wd" || _vehicle isKindOf "rhsusf_stryker_m1132_m2_d") exitWith {}; // Edited: Add support for RHSUSAF M1132
