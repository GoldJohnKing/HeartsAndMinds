...
btc_ied_deleteOn = [{
    ...
    private _ieds = allSimpleObjects [] - allSimpleObjects ["UserTexture1m_F", "Land_RepairDepot_01_tan_F"]; // Edited: Exclude "Land_RepairDepot_01_tan_F" from removable list
