...
[btc_create_object, 0, ["ACE_MainActions", "Logistic"], _action] call ace_interact_menu_fnc_addActionToObject;
_action = ["Require_veh", localize "STR_BTC_HAM_ACTION_LOGPOINT_REQVEH", "\A3\ui_f\data\map\vehicleicons\iconCar_ca.paa", {[btc_create_object_point] spawn btc_fnc_arsenal_garage}, {!isMultiplayer and btc_p_garage}, {}, [], [0, 0, 0], 5] call ace_interact_menu_fnc_createAction; // Edited: Make vehicle garage options available for all players, default = (serverCommandAvailable "#logout" || !isMultiplayer) and btc_p_garage
[btc_create_object, 0, ["ACE_MainActions", "Logistic"], _action] call ace_interact_menu_fnc_addActionToObject;
