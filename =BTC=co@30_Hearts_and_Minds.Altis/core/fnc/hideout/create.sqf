...
if (_pos isEqualTo []) then {
    private _useful = btc_city_all select {(
        ...
        {_x getVariable ["type", ""] in ["Hill", "VegetationFir", "BorderCrossing", "NameLocal", "StrongpointArea", "NameVillage", "NameCity", "NameCityCapital", "Airport"]} // Edited: Make hideout spawn in any type of city, default = _x getVariable ["type", ""] in ["NameLocal", "Hill", "NameVillage", "Airport",]
    )};
