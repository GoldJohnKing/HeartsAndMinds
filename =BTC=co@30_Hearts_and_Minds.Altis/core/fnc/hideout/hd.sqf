...
if (
    ...
    !(_hideout getVariable ["btc_mil_fnc_hd_hideout_fired", false]) && // Edited: Make the code compatible with above changes, default = {!(_hideout getVariable ["btc_mil_fnc_hd_hideout_fired", false])}
